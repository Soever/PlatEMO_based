...
% reward 
function [Xfood,fval,gbest_t] = RLSO2_16(N,T,lb,ub,dim,fobj)
...
for t = 1:T
    ...
    for i = 1: Nf
     ...
     for i = 0:round(N/10)
        newXm_dec(index(end-i),:)=tMutation(newXm_dec(index(end-i),:),t);
        newXf_dec(index1(end-i),:)=tMutation(newXf_dec(index1(end-i),:),t);
     end
